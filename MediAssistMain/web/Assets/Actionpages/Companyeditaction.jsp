...
<html>
    ...
    <body>
        ...
        <%
            ...
            String Upd="update tbl_company set ";
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (!f_item.getName().equals("")) {
                            if (field_name.equals("txtlogo"))//write the name of image here it is img_product
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Companylogo\\";//path for storing image
                                Random r = new Random();//to generate random number
                                int r_num = r.nextInt(1111) + 999;//values between this are generated

                                photo = "logo_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
...
//                {
                     ...
                     Upd += "company_name='" + value[0] + "',company_contact='" + value[1] + "',company_email='" + value[2] + "',company_address='" + value[3] + "' where company_id='" + session.getAttribute("cuserid") + "'";
   ...
   //System.out.println(Upd);
        ...
        <script type="text/javascript">
            alert("Edit Success..");
            setTimeout(function() {
                window.location.href = '../../Company/MyProfile.jsp';
