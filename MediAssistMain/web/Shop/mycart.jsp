...
<html>
    ...
    <%
        ...
        if (request.getParameter("btn_checkout") != null) {
            ...
            String selC = "select * from tbl_shoppurchasehead where shop_id='" + session.getAttribute("suserid") + "'and sph_status='0'";
    ...
    <body onload="recalculateCart()">
        <%
            ...
            if(request.getParameter("btnreq")!=null)
                {
                    String updQry = "update tbl_shoppurchasehead set sph_requeststatus ='1' where sph_id='"+request.getParameter("btnreq")+"'";
        ...
        <form method="post">
            ...
            <%      
        String id="";
        String sel = "select * from tbl_shoppurchase s inner join tbl_bmedicine b on s.bmedicine_id=b.bmedicine_id inner join tbl_cmedicine c on c.cmedicine_id=b.cmedicine_id inner join tbl_shoppurchasehead sp on sp.sph_id=s.sph_id where sp.shop_id='" + session.getAttribute("suserid") + "' and sp.sph_status='0'";
        System.out.println(sel);      
        ResultSet rs = con.selectCommand(sel);
                while (rs.next()) {
                    id=rs.getString("sph_id");
                    out.println(id);
                    String selprd = "select * from tbl_shoppurchase s inner join tbl_bmedicine b on s.bmedicine_id=b.bmedicine_id where b.cmedicine_id='" + rs.getString("cmedicine_id") + "'";
            ...
            <%  String sel4 = "select * from tbl_shoppurchasehead where sph_requeststatus='0' and sph_id='"+id+"'";
...
%>
                ...
                String sel2 = "select * from tbl_shoppurchasehead where sph_requeststatus='2' and sph_id='"+id+"'";
