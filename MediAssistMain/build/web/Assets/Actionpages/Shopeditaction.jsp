...
<html>
    ...
    <body>
        ...
        <%
            ...
            String Upd="update tbl_shop set ";
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (!f_item.getName().equals("")) {
                            if (field_name.equals("txtphoto"))//write the name of image here it is img_product
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Shopownerphoto\\";//path for storing image
...
//                {
                     ...
                     Upd += "shop_name='"+ value[0] + "',shop_contact='" + value[1]+ "',shop_email='" + value[2] + "',shop_address='" + value[3] + "',shop_ownername='" + value[4] + "',shop_owneremail='" + value[5]+"',shop_ownercontact='"+ value[6]+ "' where shop_id='" + session.getAttribute("suserid") + "'";
   ...
   //System.out.println(Upd);
        ...
        <script type="text/javascript">
            alert("Edit Success..");
            setTimeout(function() {
                window.location.href = '../../Shop/MyProfile.jsp';
