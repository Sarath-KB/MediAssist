...
<html>
    ...
    <body>
         <%
            ...
            {
            String dis="";
            String up="update tbl_complaint set complaint_reply='"+request.getParameter("txtcomplaintreply")+"',complaint_vstatus='1' where complaint_id='"+request.getParameter("eid")+"'";
